...
<%
    ...
    ResultSet rs=st.executeQuery("select * from student1 inner join result where student1.rollNo=result.rollNo and student1.rollNo='"+rollNo+"'");
    if(rs.next())
    {
%>
